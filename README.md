...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-b7urmtg.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-b7urmtg.containers.anotherwebservice.com/
...
```
git clone git@github.com:superdeen/container-b7urmtg.git
cd container-b7urmtg
```
...
```
docker attach container-b7urmtg
```
